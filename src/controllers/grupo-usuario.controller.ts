...
export class GrupoUsuarioController {
  ...
  @get('/grupos/{id}/usuarios', {
    responses: {
      '200': {
        description: 'Array of Grupo has many Usuario through UsuarioGrupo',
        content: {
          'application/json': {
  ...
  async find(
    ...
    return this.grupoRepository.grupoxusuarios(id).find(filter);
  }
  ...
  async create(
    ...
    return this.grupoRepository.grupoxusuarios(id).create(usuario);
  }
  ...
  async patch(
    ...
    return this.grupoRepository.grupoxusuarios(id).patch(usuario, where);
  }
  ...
  async delete(
    ...
    return this.grupoRepository.grupoxusuarios(id).delete(where);
  }
}
